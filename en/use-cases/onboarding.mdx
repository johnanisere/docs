...
Before a subaccount can transact, they must verify their identity. Verification is a single process where the documentation provided determines which currencies and payment rails the subaccount can access:
