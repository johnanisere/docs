...
- **Multi-balance Subaccount**: A single subaccount manages separate balances for USD, GBP, NGN, and other supported currencies.
...
- **Capability 1**: Access to USD, GBP, AED, CNY, BRL, GHS via wire, ACH, and SWIFT rails.
- **Capability 2**: Access to NGN (requires BVN), GHS, BRL via local payment rails and mobile money.
