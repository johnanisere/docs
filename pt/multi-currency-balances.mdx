...
- **Subconta Multi-saldo**: Uma única subconta gerencia saldos separados para USD, GBP, NGN e outras moedas suportadas.
...
- **Capacidade 1**: Acesso a USD, GBP, AED, CNY, BRL, GHS via trilhos wire, ACH e SWIFT.
- **Capacidade 2**: Acesso a NGN (requer BVN), GHS, BRL via trilhos de pagamento locais e mobile money.
