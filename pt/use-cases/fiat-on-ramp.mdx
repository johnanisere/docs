...
- **Subcontas não verificadas:** Todos os métodos de depósito requerem que a subconta tenha verificação aprovada. Tentar depositar em uma conta não verificada retornará um erro.
