...
Este guia cobre o fluxo completo para integrar um novo usuário (subconta), incluindo criação e verificação.
...
Antes que uma subconta possa transacionar, ela deve verificar sua identidade. A verificação é um processo único onde a documentação fornecida determina quais moedas e trilhos de pagamento a subconta pode acessar:
